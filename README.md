...
All four share the same six **faces** (state-driven, one shown at a time):
...
- **`grocery`** — vertically rolling list of low/out items with status pill; touch variants support swipe-to-remove
